...
const bulkInsertIR: any = {
  usedParamSet: { ids: true, houseAddresses: true, hasDogs: true },
  params: [
    {
      name: 'ids',
      required: false,
 ...
 * ```
 */
export const bulkInsert = new PreparedQuery<
  IBulkInsertParams,
  IBulkInsertResult
>(bulkInsertIR)
...
const countHousesIR: any = {
  usedParamSet: {},
  params: [],
  statement: 'SELECT COUNT(*) FROM house',
}
 ...
 * ```
 */
export const countHouses = new PreparedQuery<
  ICountHousesParams,
  ICountHousesResult
>(countHousesIR)
...
const bulkDeleteIR: any = {
  usedParamSet: { toyName: true },
  params: [
    {
      name: 'toyName',
      required: false,
  ...
  statement: 'DELETE FROM toy WHERE toy_name = :toyName',
}
 ...
 * ```
 */
export const bulkDelete = new PreparedQuery<
  IBulkDeleteParams,
  IBulkDeleteResult
>(bulkDeleteIR)
...
const bulkUpdateIR: any = {
  usedParamSet: { newCurrency: true, oldCurrency: true },
  params: [
    {
      name: 'newCurrency',
      required: false,
 ...
 * ```
 */
export const bulkUpdate = new PreparedQuery<
  IBulkUpdateParams,
  IBulkUpdateResult
>(bulkUpdateIR)
...
const countToysByNameIR: any = {
  ...
  statement: 'SELECT COUNT(*) FROM toy WHERE toy_name = :toyName',
}
 ...
 * ```
 */
export const countToysByName = new PreparedQuery<
  ICountToysByNameParams,
  ICountToysByNameResult
>(countToysByNameIR)
...
const countToysByCurrencyIR: any = {
  usedParamSet: { currency: true },
  params: [
    {
      name: 'currency',
      required: false,
  ...
  statement: 'SELECT COUNT(*) FROM toy WHERE currency = :currency',
}
 ...
 * ```
 */
export const countToysByCurrency = new PreparedQuery<
  ICountToysByCurrencyParams,
  ICountToysByCurrencyResult
>(countToysByCurrencyIR)
...
const paginationIR: any = {
  ...
  statement: 'SELECT * FROM cat LIMIT :limit OFFSET :offset',
}
 ...
 * ```
 */
export const pagination = new PreparedQuery<
  IPaginationParams,
  IPaginationResult
>(paginationIR)
